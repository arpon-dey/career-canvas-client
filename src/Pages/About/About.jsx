                ...
                <div className="justify-center flex-1 max-w-6xl py-4 mx-auto lg:py-6 md:px-6">
                    <div className="flex flex-wrap ">
                                ...
                                <img src="https://i.postimg.cc/rF0MKfBV/pexels-andrea-piacquadio-3760263.jpg" alt="aboutimage"
                                    ...
                                    <div
                                        ...
                                        <p className="text-lg font-semibold md:w-72">
                                            ...
                                            </svg>  connecting recruiter and job seeker  since  2000.
                                        </p>
                                    </div>
                            </div>
                        </div>
                        <div className="w-full px-6 mb-10 lg:w-1/2 lg:mb-0 ">
                            ...
                            Digitalent is your gateway to career elevation through a revolutionary platform. Effortlessly connect with talent and opportunities using our advanced bidding and job posting features. Our platform cultivates success stories within a vibrant ecosystem of collaboration and innovation. Whether you're a seeker or a provider, Digitalent transforms the way careers unfold. Join us in shaping the future of professional landscapes, where each interaction propels you towards new heights. Experience a dynamic blend of seamless connectivity and strategic opportunities, marking the intersection of talent and success on the cutting edge of Digitalent.
                            </p>
                            <a href="#"
